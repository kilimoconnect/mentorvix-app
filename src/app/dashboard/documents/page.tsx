...
import { ArrowLeft, FileText, FilePlus2, Lock } from "lucide-react";
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pb-20 md:pb-0">
        {/* Header */}
        <div className="sticky top-0 z-10 bg-white border-b border-slate-100 px-4 sm:px-6 py-4 flex items-center gap-3">
          <button
            onClick={() => router.back()}
        ...
        {/* Coming soon state */}
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-73px)] px-6 text-center py-16">
          <div
