...
import { ArrowLeft, Landmark, FilePlus2, Lock } from "lucide-react";
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pb-20 md:pb-0">
        <div className="sticky top-0 z-10 bg-white border-b border-slate-100 px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-slate-900">Loan Matches</h1>
            <p className="text-xs text-slate-500">Lenders matched to your financial profile</p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-73px)] px-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Loan Matches</h2>
          <p className="text-slate-500 max-w-sm mb-8 leading-relaxed">
            Mentorvix will match your business to the most suitable lenders and funding
            programmes once your application and financial model are complete.
          </p>
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/dashboard/apply"
              ...
              style={{ background: "linear-gradient(135deg,#0e7490,#0891b2)" }}>
              <FilePlus2 size={16} /> Complete Your Application
            </Link>
            <Link href="/dashboard"
          ...
          <div className="mt-10 flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-200">
            ...
            <span className="text-xs font-medium text-amber-700">Coming soon — lender matching is in development</span>
          </div>
        </div>
      </main>
    </div>
